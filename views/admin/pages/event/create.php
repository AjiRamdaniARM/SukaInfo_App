...
<head>
    ...
    <title>Tambah Event Baru - Sukabumi Muda</title>
...
<body>
    <section id="adminMainWrapper" class="admin-main-wrapper">
        ...
        <main class="admin-main-content container py-4">
            ...
            <form method="POST" action="/SukaInfo_app/Event/store" enctype="multipart/form-data">
                <div class="row">
                    <!-- Kiri -->
                    <div class="col-md-80">
                        <!-- Judul Event -->
                        <div class="mb-3">
                            ...
                            <input type="text" name="judul" id="judul" class="form-control" placeholder="Contoh: Sukabumi Youth Festival" required>
                        </div>

                        <!-- Lokasi -->
                        <div class="mb-3">
                            <label for="lokasi" class="form-label">Lokasi *</label>
                            <input type="text" name="lokasi" id="lokasi" class="form-control" placeholder="Contoh: Lapang Merdeka Sukabumi" required>
                        </div>
                        ...
                        <!-- Thumbnail -->
                        <div class="mb-3">
                            <label for="poster" class="form-label">Poster / Gambar Event</label>
