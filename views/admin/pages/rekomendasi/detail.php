...
<body>
    ...
    <header class="hero small-hero">
        <h1> <?= htmlspecialchars(explode(':', $rekomendasi['nama_tempat'])[0] . ':') ?></h1>
        <p><?= htmlspecialchars($rekomendasi['lokasi']) ?></p>
    </header>

    <main class="container">
        <div class="detail-content-wrapper">
            <div class="detail-berita">
                <h2 class="detail-title"><?= htmlspecialchars($rekomendasi['nama_tempat']) ?></h2>
                <div class="detail-meta">
                    ...
                    $tanggalObj = date_create($rekomendasi['tanggal']);
                    ...
                    <span class="detail-category"><?= htmlspecialchars($rekomendasi['kategori']) ?></span>

                </div>
                <div class="detail-image-container">
                    <img src="<?= htmlspecialchars($rekomendasi['poster']) ?>" alt="Sukabumi Nyerenteng #Vol1 Event" class="detail-image">
                </div>
                <div class="detail-body">
                    <?= $rekomendasi['dekiripsi'] ?>
                </div>
